...
def plot_metric(
    ...
    try:
        ...
        print(f"Retro font not found, using default. Error: {e}")
...
def create_plots():
    ...
    for i, (metric_name, data) in enumerate(all_metrics_data.items()):
        ...
        plot_metric(
            metric_name, data["rounds"], data["values"], output_path, current_line_color
        )
                ...
                if expected_key in eval_logs[first_eval_step] and isinstance(
                    ...
                    for metric in eval_metric_keys:
                        ...
                        if plot_title == "Avg Reward":
                            ...
                            png_path = os.path.join(
                                output_dir, "evaluation_f1_score.png"
                            )
                            plt.savefig(png_path, bbox_inches="tight")
                            print(f"Saved specific plot: {png_path}")
